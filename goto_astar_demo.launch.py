...
Purpose: Launches all of the needed nodes to make the robot navigate using the A* algorithm
"""
...
def generate_launch_description():
    ...
    navigator_node = Node(
        ...
        executable="navigator_astar",
        name="navigator_node",
        output="screen",
        parameters=[grid_planners_demo_dir + "/config/astar_params.yaml"],
    )
